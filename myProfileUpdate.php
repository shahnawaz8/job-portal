	...
	<div class='row'>
		<div class='col-md-2 col-sm-3'>
			<div class="list-group">
				...
				<a href="<?php echo $websiteBase;?>/jobsByMe.php" class="list-group-item ">My Jobs</a>
  				<a href="<?php echo $websiteBase;?>/myCompanyProfile.php" class="list-group-item active">My Companie</a>
			...
			if(isset($_POST['companySubmit'])){
				...
				if($e==1){
					...
					if($haveCompanyRecord[0]==0){
						mysqli_query($dbCon ,"INSERT INTO companies SET userID='$userID', name='$companyName', email='$companyEmail', contactNo='$companyMob', address='$companyAddress', info='$companyDisc'");
					}else{
						mysqli_query($dbCon ,"UPDATE companies SET name='$companyName', email='$companyEmail', contactNo='$companyMob', address='$companyAddress', info='$companyDisc' WHERE userID='$userID'");
					}
		...
		?>
					...
					<div class='row'>
						...
						<div class='col-md-6 col-sm-6'>
							<div class='form-group'>
								<label for='companyMob'>Alt. Contact No:</label>
								<input type='number' value='<?php echo $companyDetails['contactNo'];?>' name='companyMob' id='companyMob' placeholder='Enter Company Contact No' class='form-control' required>
							</div>
						</div>
					...
					<div class='row'>
						<div class='col-md-6 col-sm-6'>
							<div class='form-group'>
								<label for='companyAddress'>Permanent Address:</label>
						...
						<div class='col-md-6 col-sm-6'>
							<div class='form-group'>
								<label for='companyDisc'>Current Discription:</label>
